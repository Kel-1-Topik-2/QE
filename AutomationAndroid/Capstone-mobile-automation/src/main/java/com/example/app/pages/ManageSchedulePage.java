...
public class ManageSchedulePage extends BasePageObject {
    ...
    By textListDailySchedule() {return MobileBy.xpath("//android.view.View[@content-desc]");}
    ...
    public void verifyTextListDailyScheduleDisplayed(){Assertions.assertTrue(find(textListDailySchedule()).isDisplayed());}
}
