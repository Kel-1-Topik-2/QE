...
Feature: Add Kelola Jadwal - Admin
  ...
  Scenario Outline: As a admin i want to Add Manage Schedule Rawat Jalan - KosongTanggal
    Given Open page Kelola Jadwal
    When Click button tambah data
    And Click on the select patient action to select a patient
    And Click on the action choose a doctor to choose a doctor
  ...
  Scenario Outline: As a admin i want to Add Manage Schedule Rawat Biasa - Tidak memilih Perawat
    Given Open page Kelola Jadwal
    When Click button tambah data
    And Click on the select patient action to select a patient
    And Click on the action choose a doctor to choose a doctor
  ...
  Scenario Outline: As a admin i want to Add Manage Schedule Rawat Biasa - Tanpa tanggal dan perawat
    Given Open page Kelola Jadwal
    When Click button tambah data
    And Click on the select patient action to select a patient
    And Click on the action choose a doctor to choose a doctor
