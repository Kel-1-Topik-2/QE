...
import Starter.DataDokter.GetByDokter;
...
public class JadwalStep {
    ...
    @Steps
    GetJadwalByDoctor getJadwalByDoctor;
    @Steps
...
//Step For Get Schedule By Doctor
    @Given("I set endpoint for get schedule by token doctor")
    public void iSetEndpointForGetScheduleDataByDoctor() {
        getJadwalByDoctor.getEndpointScheduleByDoctor();
    }
    @When("I request get schedule doctor")
    public void iRequestGetScheduleDoctor() throws Exception {
        getJadwalByDoctor.requestGetDataScheduleByDoctor();
    }
    @Then("verify status code doctor data schedule is {int}")
    public void VerifyStatusCodeDoctorDataScheduleIs(int code) {
        getJadwalByDoctor.verifyStatusCodeByScheduleDoctor(code);
    }
    @And("I validate data detail after get data schedule doctor")
    public void validateTheDataDetailAfterGetDataScheduleDoctor() {
        getJadwalByDoctor.setValidateDataDetailAfterGetDataScheduleDoctor();
    }
