...
//Step For Get By Doctor
    @Given("I set endpoint for get data by token doctor")
    public void iSetEndpointForGetDataByDoctor() {
        getByDokter.getEndpointByDoctor();
    }
    @When("I request get data doctor")
    public void iRequestGetDataDoctor() throws Exception {
        getByDokter.requestGetDataByDoctor();
    }
    @Then("verify status code doctor data is {int}")
    public void VerifyStatusCodeDoctorDataIs(int code) {
        getByDokter.verifyStatusCodeByDoctor(code);
    }
    @And("I validate data detail after get data doctor")
    public void validateTheDataDetailAfterGetDataDoctor() {
        getByDokter.setValidateDataDetailAfterGetDataDoctor();
    }
