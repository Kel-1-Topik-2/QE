...
//Step For Update User Encryption
    @Given("I set an {string} for update data user encryption")
    public void iSetAnEndpointForUpdateUserEncryption(String endpoint) {
        updateUserEncryption.setAnEndpointForUpdateUserEncryption(endpoint);
    }
    @When("I request input {string} for update data user encryption")
    public void iRequestPutDetailUserEncryption(String field) throws IOException {
        updateUserEncryption.requestUpdateFieldDetailUserEncryption(field);
    }
    @Then("I validate the status code for update user encryption is {int}")
    public void iValidateTheStatusCodeForUpdateUserEncryptionIsStatusCode(int statusCode) {
        updateUserEncryption.validateTheStatusCodeForUpdateDataUserEncryption(statusCode);
    }
    ...
    public void validateTheDataDetailAfterUpdateUserEncryption(String message) {
        updateUserEncryption.validateTheDataDetailAfterUpdateUserEncryption(message);
    }
